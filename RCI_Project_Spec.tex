...
Operator-first and regenerative-calculus proposals & Candidate relation/question kernel &
Archived as proposed derivations, not adopted as live authority. G3FO uses only
antecedent diagnostic frames, partial/indeterminate outcomes, discharge-route pins, and
answer-conditioned continuation at an observed failure boundary. Generic operator
composition and semantic replacement remain deferred. \\
\bottomrule
\end{longtable}
