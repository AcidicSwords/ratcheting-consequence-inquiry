...
Inquiry (RCI) version 0.3.1. It is a reconciled rewrite of the archived research
...
\toprule
Source & Role in 0.3.1 & Reconciliation \\
\midrule
\endhead
...
assumed unless the binding declares them.
...
failures MUST NOT become fabricated mismatches.
...
G3A implements generic exact quotient, retention capability routes, exact
rational finite/linear bindings, residue, horizon reopening, and route-specific
\texttt{RecoveryLicense} enforcement. G3B implements approximate loss licenses,
...
or reconstruction MUST NOT be interpreted as absence of retained learning.
...
\item \path{docs/goals/}: bounded milestone targets, including sealed G1/G2A and active G2B;
